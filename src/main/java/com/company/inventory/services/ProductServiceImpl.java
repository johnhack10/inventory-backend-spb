...
public class ProductServiceImpl implements IProductService {
	...
	public ResponseEntity<ProductResponseRest> save(Product product, Long categoryId) {
		...
		try {
			...
			if( category.isPresent() ) {
				...
				response.setMetadata("Respuesta err", "-1", "Categoria no encontrada asociada al producto");
			...
			if( productSaved != null ) {
				...
				response.setMetadata("Respuesta err", "-1", "Producto no guardado");
				return new ResponseEntity<ProductResponseRest>(response, HttpStatus.BAD_REQUEST);
			}
				
		} catch ( Exception e ) {
			e.getStackTrace();
			response.setMetadata("Respuesta err", "-1", "Error al guardar producto");
	...
	public ResponseEntity<ProductResponseRest> searchById(Long id) {		
		...
		try {			
			...
			e.getStackTrace();
			response.setMetadata("Respuesta err", "-1", "Error al buscar el producto");
			return new ResponseEntity<ProductResponseRest>(response, HttpStatus.INTERNAL_SERVER_ERROR);
		}
	...
	public ResponseEntity<ProductResponseRest> searchByName(String name) {
		...
		try {			
			...
			e.getStackTrace();
			response.setMetadata("Respuesta err", "-1", "Error al buscar el productos");
			return new ResponseEntity<ProductResponseRest>(response, HttpStatus.INTERNAL_SERVER_ERROR);
		}
	...
	public ResponseEntity<ProductResponseRest> deleteById(Long id) {
		...
		try {			
			...
			e.getStackTrace();
			response.setMetadata("Respuesta err", "-1", "Error al eliminar el producto");
			return new ResponseEntity<ProductResponseRest>(response, HttpStatus.INTERNAL_SERVER_ERROR);
		}
	...
	public ResponseEntity<ProductResponseRest> search() {
		...
		try {			
			...
			e.getStackTrace();
			response.setMetadata("Respuesta err", "-1", "Error al buscar el producto por nombre");
			return new ResponseEntity<ProductResponseRest>(response, HttpStatus.INTERNAL_SERVER_ERROR);
		}
	...
	public ResponseEntity<ProductResponseRest> update(Product product, Long categoryId, Long id) {
		...
		try {
			...
			if( productSearch.isPresent() ) {
				...
				response.setMetadata("Respuesta err", "-1", "Producto no actualizado");
				return new ResponseEntity<ProductResponseRest>(response, HttpStatus.NOT_FOUND);
			}
